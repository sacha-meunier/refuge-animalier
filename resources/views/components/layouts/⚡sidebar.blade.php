...
<div class="h-dvh w-2xs min-w-2xs">
    <nav class="fixed border-r border-border bg-sidebar text-sidebar-foreground h-full w-2xs min-w-2xs flex-grow-0 flex flex-col gap-7 p-4">
        <header>
