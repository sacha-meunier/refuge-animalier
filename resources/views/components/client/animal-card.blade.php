...
<a
    ...
    {{ $attributes->merge(["class" => "group block bg-card border border-border rounded-2xl overflow-hidden hover:shadow-lg transition-shadow touch-target"]) }}
>
    {{-- Image --}}
    ...
    <div class="p-4 relative">
        <div class="pr-10 flex flex-col">
            {{-- Animal name --}}
            <h3 class="text-lg font-semibold text-foreground group-hover:text-primary transition-colors order-2">
                {{ $animal->name }}
            </h3>
